...
) ENGINE=InnoDB AUTO_INCREMENT=362 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='   ';
...
) ENGINE=InnoDB AUTO_INCREMENT=653 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='   ';
...
CREATE TABLE `event` (
  ...
  `pagedepth` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='			';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='	';
...
) ENGINE=InnoDB AUTO_INCREMENT=39091 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=1468 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='		';
